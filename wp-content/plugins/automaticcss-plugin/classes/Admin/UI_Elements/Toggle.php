	...
	public function render() {
		...
		printf(
			'<div class="acss-value__input-wrapper--toggle" data-default="%3$s" data-toggle-name="%2$s">
				...
				<label class="acss-value__label acss-value__label--toggle acss-value__label--toggle-on" for="%2$s-%4$s"><span>%4$s</span></label>
				...
				<label class="acss-value__label acss-value__label--toggle acss-value__label--toggle-off" for="%2$s-%6$s"><span>%6$s</span></label>
			</div>',
